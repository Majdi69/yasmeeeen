...
class EvenementController extends AbstractController
{
    ...
    public function addevent(Request $request, ManagerRegistry $doctrine , SluggerInterface $slugger, FlashyNotifier $flashy, \Symfony\Component\Security\Core\Security $security,EvenementRepository $repository
    )
    {
        $event= new Evenement();
